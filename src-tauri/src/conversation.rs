...
use crate::gpt::{Role, MessageDelta};
...
impl Conversation {
    ...
    pub async fn prompt(&self, prompt: &str, api_key: &str) -> Result<(), PromptError> {
        ...
        
        {
            ...
            let mut delta_stream = gpt::Request::new(self.messages.lock().await.clone(), "gpt-4-0314").do_request(api_key)?;
